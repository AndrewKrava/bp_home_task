...
// Решение
type Filter = <T>(array: T[], fn: (item: T, index: number, arrayRef: T[]) => boolean) => T[];
...
// type Fn = <T>(item: T, index: number, arrayRef: T[]) => boolean;

// function filter<T>(array: T[], fn: Fn) {
//     const resultArr = [];
//     for (let index = 0; index < array.length; index++) {
//         if (fn<T>(array[ index ], index, array)) {
//             resultArr.push(array[ index ]);
//         }
//     }
